...
class IndexView {
    ...
    {
        ?>
                    <footer class="footer d-block w-100 bg-dark py-3">
                        <div class="container d-flex justify-content-between">
                        <p class="text-muted"> &copy; Group 3 - I211 Final Project</p>
                        <div class="text-muted">
                            <p><a href="https://www.formula1.com">Data Source: F1 Website</a> |
                            <a href="https://www.postman.com/maintenance-astronomer-29796265/workspace/f1-api/collection/19328871-63c4a82c-ae84-4a24-a58b-bd8a408b1c4e?ctx=documentation">Standings: F1 Postman API </a> | 
                            <a href="https://racingnews365.com/formula-1-calendar-2022">Race Calendar Source</a></p>
                        </div>
                    </div>
                </footer>
            </body>
